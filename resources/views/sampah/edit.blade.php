...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <img src ="/img/BANK-SAMPAH-PNG.png" style="width:50px;">
                <h2 class="float-left mt-2">Edit Data Sampah</h2>
            </ul>
        </div>
    </nav>
    <div class="container">
    ...
    <form action="{{ route('update', $sampahs['id']) }}" method="POST">
      ...
      <input type="text" value="{{ $sampahs['kepala_keluarga'] }}"  name="kepala_keluarga"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label">No Rumah</label>
      <input type="text"  value="{{ $sampahs['no_rumah'] }}"  name="no_rumah"  class="form-control" id="exampleInputPassword1">
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label">Rt/Rw</label>
      <input type="text"  value="{{ $sampahs['rt_rw'] }}"  name="rt_rw"  class="form-control"  id="exampleInputPassword1">
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label">total karung sampah</label>
      <input type="number"  value="{{ $sampahs['total_karung_sampah'] }}"  name="total_karung_sampah"  class="form-control" id="exampleInputPassword1">
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label">tanggal pengangkutan</label>
      <input type="date"  value="{{ $sampahs['tanggal_pengangkutan'] }}"  name="tanggal_pengangkutan"  class="form-control"  id="exampleInputPassword1">
    </div>
